...
<aside>
                ...
                <ul id="gnb">
                    <li>
                        ...
                        <ol>
                            <li><a href="/Kmarket/seller/product/list.do">상품현황</a></li>
                    ...
                    <li>
                        ...
                        <ol>
                            <li><a href="/Kmarket/seller/order/order.do">주문현황</a></li>
                            <li><a href="/Kmarket/seller/order/delivery.do">취소/반품/교환</a></li>
                        </ol>
                    </li>
                    <li>
